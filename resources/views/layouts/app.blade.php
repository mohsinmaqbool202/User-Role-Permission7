...
<head>
    ...
    <title>{{ config('app.name', 'Handle User Role and Permissions') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('all.orders') }}">Orders</a></li>
                            <li><a class="nav-link" href="{{ route('all.customers')}}">Customers</a></li>
