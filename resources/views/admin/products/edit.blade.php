    ...
    <form action="{{ route('products.update',$product->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="color" value="{{ $product->color }}" class="form-control" placeholder="Colour">
                </div>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <strong>Stock:</strong>
                    <input type="text" name="stock" value="{{ $product->stock }}" class="form-control" placeholder="Price">
                </div>
            </div>
            <!-- <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
